...
/**
 * Start periodic NDP injection timer for consistent CSI sensing.
 *
 * Sends a Null Data Packet every 50ms (20 Hz) to generate stable,
 * predictable CSI measurements across all nodes. This dramatically
 * improves sensing quality compared to relying on ambient WiFi traffic.
 */
